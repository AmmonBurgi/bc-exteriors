...
import { Stone, House, Ruler, BrickWall, CloudRain } from "lucide-react";
...
const services = [
  ...
  { icon: BrickWall, title: "Masonry", desc: "Expert masonry services." },
  { icon: CloudRain, title: "Gutters", desc: "Reliable gutter, soffit, and fascia installation." },
];
